        ...
        <div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item " :class="{ 'kt-menu__item--active': $page.component.startsWith('Admin/user') }"
                 ...
                 <li class="kt-menu__section ">
                    <h4 class="kt-menu__section-text">Role Management</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2">
                    </i>
                </li>

                 <li class="kt-menu__item" :class="{ 'kt-menu__item--active': $page.component.startsWith('Admin/role') }"
                    aria-haspopup="true">
                    <Link :href="route('admin.role')" class="kt-menu__link " >
                        <Icon icon="icon-park-outline:permissions" color="white" width="24" height="24" class="kt-menu__link-icon" />
               ...
               <li class="kt-menu__section ">
                 ...
                 <li class="kt-menu__item" :class="{ 'kt-menu__item--active': $page.component.startsWith('Admin/category') }"
                    aria-haspopup="true">
                    <Link :href="route('admin.category')" class="kt-menu__link " >
                        <Icon icon="carbon:category" color="white" width="24" height="24" class="kt-menu__link-icon" />
...
<!-- <div v-if="mobileMenuHideShow" class="kt-aside-overlay"></div> -->
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <Link href="/admin/logout" method="post" as="button" type="button">Logout</Link>
      </li>
